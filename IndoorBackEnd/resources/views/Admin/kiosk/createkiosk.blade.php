...
@section('admin-title', 'Create Kiosk')
            ...
            <div class="col-3">
                <div class="card m-1">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('kiosk') }}" method="post">
                            @csrf
                            <div class="form-group">
                                <div class="col-md-12 col-sm-12 mt-1">
                                    <label class="col-12 col-md-12 col-lg-12" for="kioksname"><b>Kioks Name</b></label>
                                    <input type="text" class="form-control col-md-12 col-12" name="kioksname"
                                        id="kioksname">
                                    <font color="red">
                                        <b> @error('kioksname')
                            ...
                            <div class="form-group">
                                <div class="col-md-12 col-sm-12 mt-1">
                                    ...
                                    <input type="text" class="form-control col-md-12 col-12" name="latitude"
                                        id="latitude">
                                </div>
                                <font color="red">
                                    <b> @error('latitude')
