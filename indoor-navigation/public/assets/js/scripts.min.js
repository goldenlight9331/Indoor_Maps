...
var swiper = new Swiper(".swiper-container", {
  ...
  pagination: {
    ...
    renderBullet: function (e, t) {
      return '<span class="' + t + ' pagination-dots"></span>';
    },
  },
  navigation: { nextEl: ".page-button-next", prevEl: ".page-button-prev" },
});
...
toggleButtons.forEach((e) => {
  e.addEventListener("click", () => {
    ...
    "./img/toggle-off.svg" === t.getAttribute("src")
      ? t.setAttribute("src", "./img/toggle-on.svg")
      : t.setAttribute("src", "./img/toggle-off.svg");
  });
});
